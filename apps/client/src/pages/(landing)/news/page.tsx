  ...
  return (
    <div className="container py-20">
      <div className="grid gap-5">
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
          <div className="flex flex-col gap-1">
            ...
            <p className="max-w-xl">
              Dergilerle ilgili en son haberleri ve makaleleri burada bulabilirsiniz. Dergiler,
              edebiyat dünyasındaki en önemli yayın organlarından biridir.
            </p>
            <p className="text-muted text-sm">{news.items.length} haber bulundu.</p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-center" hidden={news.items.length === 0}>
          <Pagination
            onChange={(page) =>
